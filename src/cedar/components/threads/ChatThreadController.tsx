...
import {
	...
	DropdownMenuItem,
	DropdownMenuTrigger,
} from '@/src/cedar/components/ui/dropdown-menu';
import { Pencil, History, Trash } from 'lucide-react';
import { Button } from '@/src/cedar/components/ui/button';
			...
			{showThreadList && (
				<DropdownMenu>
					...
					<DropdownMenuContent align='end' className='w-56 p-1'>
						{threads.map(
							({ id, name, messageCount, lastMessage, isDefault }) => (
								<DropdownMenuItem
									key={id}
									className={cn(
